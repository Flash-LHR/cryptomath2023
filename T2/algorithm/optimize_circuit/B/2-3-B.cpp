...
QAND(F[0], Y[9], z[1]);
//d
T[32] = T[32] + T[40] + T[7] + U[6] + Y[14] + Y[3];
T[30] = T[30] + T[4] + T[6] + U[3] + z[13] + z[16] + z[2] + z[3];
T[40] = T[40] + 1 + T[11] + U[5] + z[15];
T[9] = T[9] + T[36] + Y[13] + z[10];
U[3] = U[3] + T[12] + T[5] + U[0] + U[7] + Y[14] + Y[3] + z[12] + z[13] + z[3];
T[36] = T[36] + T[10] + T[12] + U[4] + U[5] + z[11] + z[10] + z[1];
T[5] = T[5] + T[4] + U[2];
Y[2] = Y[2] + T[32] + T[8] + Y[6] + z[0];
U[1] = U[1] + Y[12] + z[4];
z[11] = z[11] + T[9] + z[8];
//d
S[0] = S[0] + U[0] + U[5] + z[9] + z[15] + z[16] + T[5] + T[9] + T[32];
